...
class _RegisterPageState extends State<RegisterPage> {
      ...
      child: Form(
        ...
        child: Column(
          children: <Widget>[
            ...
            formFieldSpacing,
            buildFormVehicleNumberField('Vehicle Number', LineIcons.car,_vehicleNumberController),
            formFieldSpacing,
          ],
        ),
      ),
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: MaterialButton(
            ...
            onPressed: () async {
              _emailValidator =0;
              if (_formKey.currentState.validate() && _genderRadioBtnVal != null && birthDate != null ) {
  ...
  void userUploadData() async {
    FirebaseFirestore.instance.collection("Driver").doc(_nationalIDNumberController.text).set({
      'Name': _nameController.text,
      'Email Address': _emailController.text,
      'Phone Number': _phoneNumberController.text,
      'NIC Number': _nationalIDNumberController.text,
      'vehicle Number': _nationalIDNumberController.text,
      'Gender': genderUpdate,
      'Birth Day': birthDate,
    }).then((_) {
      print("success!");
